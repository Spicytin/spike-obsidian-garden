...
| **Mod**                                                                                                                                            | **Description** | **Loader** | **Environment** |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ---------- | --------------- |
| ***[Bad Optimizations](https://modrinth.com/mod/g96Z4WVZ)***                                                                                       |                 |            |                 |
| ***[Better Beds](https://modrinth.com/mod/better-beds)***                                                                                          |                 |            |                 |
| ***[Better Grassify](https://modrinth.com/mod/m5T5xmUy)***                                                                                         |                 |            |                 |
| ***[Bobby](https://modrinth.com/mod/bobby)***                                                                                                      |                 |            |                 |
| ***[Clumps](https://modrinth.com/mod/Wnxd13zP)***                                                                                                  |                 |            |                 |
| ***Concurrent Chunk Management Engine*** ([Fabric](https://modrinth.com/mod/c2me-fabric), [NeoForge](https://modrinth.com/mod/c2me-neoforge))      |                 |            |                 |
| ***Cull Less Leaves*** ([Fabric](https://modrinth.com/mod/cull-less-leaves), [Forge](https://modrinth.com/mod/cull-less-leaves-reforged/versions)) |                 |            |                 |
...
| ***[Sodium](https://modrinth.com/mod/AANobbMI)*** (Fabric) / ***[Embeddium](https://modrinth.com/mod/sk9rgfiA)*** ((Neo)Forge)                     |                 |            |                 |
| ***[Sodium Extra](https://modrinth.com/mod/AANobbMI)*** (Fabric) / ***[Embeddium Extra](https://modrinth.com/mod/oY2B1pjg)*** ((Neo)Forge)         |                 |            |                 |
| ***[Starlight](https://modrinth.com/mod/iRfIGC1s)***                                                                                               |                 |            |                 |
| ***[Video Tape](https://modrinth.com/mod/LVTZtqlk)***/***[GPU Tape](https://modrinth.com/mod/5CTSrY8X)***                                          |                 |            |                 |
